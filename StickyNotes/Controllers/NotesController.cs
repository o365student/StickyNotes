...
namespace StickyNotes.Controllers
{
    public class NotesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Content,CreatedUtc")] Note note)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Content,CreatedUtc")] Note note)
        {
            if (id != note.Id)
            {
                return NotFound();
